...
<section class="wrapper">
  ...
  <p className="lead">Welcome to our CSCE 436 portfolio</p>
    ...
    <div className="embed-responsive embed-responsive-16by9">
        <iframe
            width="90%" height="650"
            src="https://www.youtube.com/embed/9VzCj7ZNL2g"
        ...
        <section className="section my-5" id="slides">
          ...
          <iframe src="slides.pdf" title="Google Slides Presentation" rameborder="0" width="90%" height="650px" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
        </section>
